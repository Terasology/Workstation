...
public class FillFluidInventoryPart implements Component, ProcessPart, ValidateInventoryItem {
    ...
    public void executeStart(EntityRef instigator, EntityRef workstation, EntityRef processEntity) {
        ...
        if (removedItem != null) {
            ...
            if (CoreRegistry.get(InventoryManager.class).giveItem(workstation, instigator, removedItem,
                    WorkstationInventoryUtils.getAssignedSlots(workstation, "FLUID_CONTAINER_OUTPUT"))) {
                return;
            }
