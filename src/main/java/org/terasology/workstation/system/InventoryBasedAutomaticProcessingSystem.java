...
public class InventoryBasedAutomaticProcessingSystem extends BaseComponentSystem {
    @ReceiveEvent
    public void newItemInWorkstation(InventorySlotChangedEvent event, EntityRef workstation,
                                     WorkstationComponent workstationComponent) {
        workstation.send(new WorkstationStateChanged());
    }

    @ReceiveEvent
    public void itemCountChangedInWorkstation(InventorySlotStackSizeChangedEvent event, EntityRef workstation,
                                              WorkstationComponent workstationComponent) {
        workstation.send(new WorkstationStateChanged());
    }

    @ReceiveEvent
    public void fluidInventoryChangedInWorkstation(OnChangedComponent event, EntityRef workstation,
                                                   WorkstationComponent workstationComponent,
